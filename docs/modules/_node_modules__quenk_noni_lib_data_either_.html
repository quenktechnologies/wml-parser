...
<head>
	...
	<title>&quot;node_modules/@quenk/noni/lib/data/either&quot; | @quenk/wml-parser</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-class tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
			<a href="../classes/_node_modules__quenk_noni_lib_data_either_.either.html" class="tsd-kind-icon">Either</a>
		</li>
		<li class=" tsd-kind-class tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
			<a href="../classes/_node_modules__quenk_noni_lib_data_either_.left.html" class="tsd-kind-icon">Left</a>
		</li>
		<li class=" tsd-kind-class tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
			<a href="../classes/_node_modules__quenk_noni_lib_data_either_.right.html" class="tsd-kind-icon">Right</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
			<a href="_node_modules__quenk_noni_lib_data_either_.html#either-1" class="tsd-kind-icon">either</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-external-module tsd-is-external">
			<a href="_node_modules__quenk_noni_lib_data_either_.html#fromboolean" class="tsd-kind-icon">from<wbr>Boolean</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
			<a href="_node_modules__quenk_noni_lib_data_either_.html#left-1" class="tsd-kind-icon">left</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
			<a href="_node_modules__quenk_noni_lib_data_either_.html#right-1" class="tsd-kind-icon">right</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Either represents a value that may be one of two types.</p>
				</div>
				<p>An Either is either a Left or Right. Mapping and related functions over the
					Left side returns the value unchanged. When the value is Right
				functions are applied as normal.</p>
				<p>The Either concept is often used to accomodate error handling but there
				are other places it may come in handy.</p>
				<p>An important point to note when using this type is that the left side
				...
				together via map,chain etc.</p>
				<p>This turns up compiler errors in unexpected places and is sometimes rectified
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-class tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external"><a href="../classes/_node_modules__quenk_noni_lib_data_either_.either.html" class="tsd-kind-icon">Either</a></li>
							<li class="tsd-kind-class tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external"><a href="../classes/_node_modules__quenk_noni_lib_data_either_.left.html" class="tsd-kind-icon">Left</a></li>
							<li class="tsd-kind-class tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external"><a href="../classes/_node_modules__quenk_noni_lib_data_either_.right.html" class="tsd-kind-icon">Right</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Functions</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external"><a href="_node_modules__quenk_noni_lib_data_either_.html#either-1" class="tsd-kind-icon">either</a></li>
							<li class="tsd-kind-function tsd-parent-kind-external-module tsd-is-external"><a href="_node_modules__quenk_noni_lib_data_either_.html#fromboolean" class="tsd-kind-icon">from<wbr>Boolean</a></li>
							<li class="tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external"><a href="_node_modules__quenk_noni_lib_data_either_.html#left-1" class="tsd-kind-icon">left</a></li>
							<li class="tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external"><a href="_node_modules__quenk_noni_lib_data_either_.html#right-1" class="tsd-kind-icon">right</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
				<a name="either-1" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagConst">Const</span> either</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">either&lt;A, B, C&gt;<span class="tsd-signature-symbol">(</span>f<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">function</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">(Anonymous function)</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in node_modules/@quenk/noni/lib/data/either.ts:337</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>either given two functions, first for Left, second for Right, will return
								the result of applying the appropriate function to an Either&#39;s internal value.</p>
							</div>
						</div>
								...
								<ul class="tsd-parameters">
									<li class="tsd-parameter-siganture">
										<ul class="tsd-signatures tsd-kind-type-literal tsd-is-not-exported">
											<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">(</span>a<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">C</span></li>
										</ul>
										<ul class="tsd-descriptions">
											<li class="tsd-description">
												<h4 class="tsd-parameters-title">Parameters</h4>
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-external-module tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-external-module tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">from<wbr>Boolean<span class="tsd-signature-symbol">(</span>b<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../classes/_node_modules__quenk_noni_lib_data_either_.either.html" class="tsd-signature-type">Either</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in node_modules/@quenk/noni/lib/data/either.ts:330</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>fromBoolean constructs an Either using a boolean value.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
						...
						<h4 class="tsd-returns-title">Returns <a href="../classes/_node_modules__quenk_noni_lib_data_either_.either.html" class="tsd-signature-type">Either</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">&gt;</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
				<a name="left-1" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagConst">Const</span> left</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">left&lt;A, B&gt;<span class="tsd-signature-symbol">(</span>a<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../classes/_node_modules__quenk_noni_lib_data_either_.either.html" class="tsd-signature-type">Either</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type">B</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in node_modules/@quenk/noni/lib/data/either.ts:320</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>left constructor helper.</p>
							</div>
						</div>
						<h4 class="tsd-type-parameters-title">Type parameters</h4>
						<ul class="tsd-type-parameters">
						...
						<h4 class="tsd-returns-title">Returns <a href="../classes/_node_modules__quenk_noni_lib_data_either_.either.html" class="tsd-signature-type">Either</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type">B</span><span class="tsd-signature-symbol">&gt;</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
				<a name="right-1" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagConst">Const</span> right</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">right&lt;A, B&gt;<span class="tsd-signature-symbol">(</span>b<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">B</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../classes/_node_modules__quenk_noni_lib_data_either_.either.html" class="tsd-signature-type">Either</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type">B</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in node_modules/@quenk/noni/lib/data/either.ts:325</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>right constructor helper.</p>
							</div>
						</div>
						<h4 class="tsd-type-parameters-title">Type parameters</h4>
						<ul class="tsd-type-parameters">
