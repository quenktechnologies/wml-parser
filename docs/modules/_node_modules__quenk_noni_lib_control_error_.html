...
<head>
	...
	<title>&quot;node_modules/@quenk/noni/lib/control/error&quot; | @quenk/wml-parser</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-interface tsd-parent-kind-external-module tsd-is-external">
			<a href="../interfaces/_node_modules__quenk_noni_lib_control_error_.err.html" class="tsd-kind-icon">Err</a>
		</li>
		<li class=" tsd-kind-type-alias tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
			<a href="_node_modules__quenk_noni_lib_control_error_.html#except" class="tsd-kind-icon">Except</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
			<a href="_node_modules__quenk_noni_lib_control_error_.html#attempt" class="tsd-kind-icon">attempt</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-external-module tsd-is-external">
			<a href="_node_modules__quenk_noni_lib_control_error_.html#convert" class="tsd-kind-icon">convert</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-external-module tsd-is-external">
			<a href="_node_modules__quenk_noni_lib_control_error_.html#raise" class="tsd-kind-icon">raise</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>This module provides functions and types to make dealing with ES errors
					easier.</p>
				</div>
			</div>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-interface tsd-parent-kind-external-module tsd-is-external"><a href="../interfaces/_node_modules__quenk_noni_lib_control_error_.err.html" class="tsd-kind-icon">Err</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Type aliases</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-type-alias tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external"><a href="_node_modules__quenk_noni_lib_control_error_.html#except" class="tsd-kind-icon">Except</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Functions</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external"><a href="_node_modules__quenk_noni_lib_control_error_.html#attempt" class="tsd-kind-icon">attempt</a></li>
							<li class="tsd-kind-function tsd-parent-kind-external-module tsd-is-external"><a href="_node_modules__quenk_noni_lib_control_error_.html#convert" class="tsd-kind-icon">convert</a></li>
							<li class="tsd-kind-function tsd-parent-kind-external-module tsd-is-external"><a href="_node_modules__quenk_noni_lib_control_error_.html#raise" class="tsd-kind-icon">raise</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
				...
				<h3>Except</h3>
				<div class="tsd-signature tsd-kind-icon">Except<span class="tsd-signature-symbol">:</span> <a href="../classes/_node_modules__quenk_noni_lib_data_either_.either.html" class="tsd-signature-type">Either</a><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/_node_modules__quenk_noni_lib_control_error_.err.html" class="tsd-signature-type">Err</a><span class="tsd-signature-symbol">, </span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">&gt;</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in node_modules/@quenk/noni/lib/control/error.ts:14</li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Except type represents a value that may fail with an error.</p>
					</div>
					<p>It is a specific version of Either.</p>
				</div>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
				...
				<h3><span class="tsd-flag ts-flagConst">Const</span> attempt</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-external-module tsd-has-type-parameter tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">attempt&lt;A&gt;<span class="tsd-signature-symbol">(</span>f<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">function</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="_node_modules__quenk_noni_lib_control_error_.html#except" class="tsd-signature-type">Except</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in node_modules/@quenk/noni/lib/control/error.ts:65</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>attempt a synchronous computation that may throw an exception.</p>
							</div>
						</div>
								...
								<ul class="tsd-parameters">
									<li class="tsd-parameter-siganture">
										<ul class="tsd-signatures tsd-kind-type-literal tsd-is-not-exported">
											<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">A</span></li>
										</ul>
										<ul class="tsd-descriptions">
											<li class="tsd-description">
						...
						<h4 class="tsd-returns-title">Returns <a href="_node_modules__quenk_noni_lib_control_error_.html#except" class="tsd-signature-type">Except</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">A</span><span class="tsd-signature-symbol">&gt;</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-external-module tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-external-module tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">convert<span class="tsd-signature-symbol">(</span>e<span class="tsd-signature-symbol">: </span><a href="../interfaces/_node_modules__quenk_noni_lib_control_error_.err.html" class="tsd-signature-type">Err</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Error</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in node_modules/@quenk/noni/lib/control/error.ts:39</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>convert an Err to an Error.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>e: <a href="../interfaces/_node_modules__quenk_noni_lib_control_error_.err.html" class="tsd-signature-type">Err</a></h5>
							</li>
						</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-external-module tsd-is-external">
				...
				<h3><span class="tsd-flag ts-flagConst">Const</span> raise</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-external-module tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">raise<span class="tsd-signature-symbol">(</span>e<span class="tsd-signature-symbol">: </span><a href="../interfaces/_node_modules__quenk_noni_lib_control_error_.err.html" class="tsd-signature-type">Err</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">never</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in node_modules/@quenk/noni/lib/control/error.ts:48</li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>raise the supplied Error.</p>
							</div>
							<p>This function exists to maintain a functional style in situations where
							you may actually want to throw an error.</p>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
